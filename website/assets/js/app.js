...
function initDashboard() {
  ...
  if (ctx) {
    ...
    new Chart(ctx, {
      type: 'bar',
      data: {
        labels: ["Linear Regression", "Random Forest", "XGBoost", "Tuned XGBoost"],
        datasets: [{
          data: [0.8176, 0.9040, 0.9125, 0.9182],
          backgroundColor: ["rgba(99, 102, 241, 0.3)", "rgba(99, 102, 241, 0.55)", "rgba(99, 102, 241, 0.75)", "#6366f1"],
          borderRadius: 6
        }]
      },
      options: {
  ...
  if (maeCtx) {
    new Chart(maeCtx, {
      ...
      data: {
        labels: ["Linear Regression", "Random Forest", "XGBoost", "Tuned XGBoost"],
        datasets: [{
          data: [14250, 8620, 7980, 7340],
          backgroundColor: ["rgba(6, 182, 212, 0.3)", "rgba(6, 182, 212, 0.55)", "rgba(6, 182, 212, 0.75)", "#06b6d4"],
          borderRadius: 4
        }]
      },
      options: {
  ...
  if (rmseCtx) {
    new Chart(rmseCtx, {
      ...
      data: {
        labels: ["Linear Regression", "Random Forest", "XGBoost", "Tuned XGBoost"],
        datasets: [{
          data: [19840, 11260, 10480, 9710],
          backgroundColor: ["rgba(139, 92, 246, 0.3)", "rgba(139, 92, 246, 0.55)", "rgba(139, 92, 246, 0.75)", "#8b5cf6"],
          borderRadius: 4
        }]
      },
      options: {
